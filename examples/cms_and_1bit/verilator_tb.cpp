...
int main(int argc, char **argv) 
{
    ...
    tb->m_core->Y2_i = Y2;
    tb->m_core->Y3_i = Y3;
    tb->m_core->Z0_i = rand() & 0x01;
    tb->m_core->Z1_i = rand() & 0x01;
    tb->m_core->Z2_i = rand() & 0x01;
    tb->m_core->Z3_i = rand() & 0x01;
    tb->m_core->Z4_i = rand() & 0x01;
    tb->m_core->Z5_i = rand() & 0x01;
    tb->m_core->Z6_i = rand() & 0x01;
    tb->m_core->Z7_i = rand() & 0x01;
    tb->m_core->Z8_i = rand() & 0x01;
    tb->m_core->Z9_i = rand() & 0x01;
    tb->m_core->Z10_i = rand() & 0x01;
    tb->m_core->Z11_i = rand() & 0x01;
    tb->m_core->Z12_i = rand() & 0x01;
    tb->m_core->Z13_i = rand() & 0x01;
    tb->m_core->Z14_i = rand() & 0x01;
    tb->m_core->Z15_i = rand() & 0x01;
